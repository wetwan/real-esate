...
const Abouts = () => {
  ...
  return (
    <div className="flex items-center justify-center pb-10">
      ...
      <div className=" top-[170vh] h-[45vh] absolute lg:w-4/6 sm:w-5/6 mx-auto ">
        <video
          src={assests.vid}
      ...
      <div className="top-[225vh] h-[50vh] flex items-center justify-center absolute w-full  ">
      ...
      {image && (
        <div className="fixed overflow-hidden z-40 flex items-center justify-center shadow-2xl top-0 bottom-[20vh] right-0 left-0 bg-transparen bg-white/70 p-10 h-full  w-full ">
          <img src={img} alt="" className=" w-[500px]  h-[500px]  " />
          <div
            className="absolute text-white top-[22%] text-2xl rounded-full p-1 w-10 text-center h-10 left-[62%]  bg-red-600 "
